...
func (pq *PostQuery) QueryLikes() *LikesQuery {
	query := &LikesQuery{config: pq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *PostQuery) WithLikes(opts ...func(*LikesQuery)) *PostQuery {
	query := &LikesQuery{config: pq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *PostQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Post, error) {
	...
	if query := pq.withLikes; query != nil {
		if err := pq.loadLikes(ctx, query, nodes,
			func(n *Post) { n.Edges.Likes = []*Likes{} },
			func(n *Post, e *Likes) { n.Edges.Likes = append(n.Edges.Likes, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PostQuery) loadLikes(ctx context.Context, query *LikesQuery, nodes []*Post, init func(*Post), assign func(*Post, *Likes)) error {
	...
	query.Where(predicate.Likes(func(s *sql.Selector) {
