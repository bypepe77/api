...
// was not loaded in eager-loading.
func (e PostEdges) LikesOrErr() ([]*Likes, error) {
	if e.loadedTypes[2] {
		return e.Likes, nil
	}
...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case post.FieldHashtags, post.FieldLinks:
			values[i] = new([]byte)
	...
	for i := range columns {
		...
		case post.FieldLinks:
			if value, ok := values[i].(*[]byte); !ok {
				...
				if err := json.Unmarshal(*value, &po.Links); err != nil {
...
func (po *Post) QueryLikes() *LikesQuery {
...
func (po *Post) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", po.Links))
	builder.WriteString(", ")
	builder.WriteString("shared=")
	builder.WriteString(fmt.Sprintf("%v", po.Shared))
	builder.WriteByte(')')
