...
func (uq *UserQuery) QueryLikes() *LikesQuery {
	query := &LikesQuery{config: uq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) WithLikes(opts ...func(*LikesQuery)) *UserQuery {
	query := &LikesQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withLikes; query != nil {
		if err := uq.loadLikes(ctx, query, nodes,
			func(n *User) { n.Edges.Likes = []*Likes{} },
			func(n *User, e *Likes) { n.Edges.Likes = append(n.Edges.Likes, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadLikes(ctx context.Context, query *LikesQuery, nodes []*User, init func(*User), assign func(*User, *Likes)) error {
